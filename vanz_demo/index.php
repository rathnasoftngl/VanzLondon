...
<div class="container" style="margin-top:8%;">
	<div class="row">
		<div class="col-md-12 ban">
			<div style="text-align:center; margin:20px;"><span style="font-size:24px; color:#000000; text-align:center;">“House of Fashion” </span><br />
 			<span style="font-size:18px; color:#000000; text-align:center;">"Place your order now for delivery to home or visit our store”</span></div>
		</div>
	</div>
</div> 
...
<div class="container" style="margin-top:15px;">
	<div class="row">
		<div class="col-md-4">
        <div class="ind_prod">
			<a href="product.php?w=3"><img class="img-responsive" src="images/col1.jpg" alt="" style="width:100%;" >
            <p class="ind_shop">SUITS</p></a>
		</div>
        </div>
		<!--<div class="col-md-4">
        <div class="ind_prod">
			<img class="img-responsive" src="images/col2.jpg" alt="" style="width:100%;" >
            <a href="product.php?w=1&cid=3"><p class="ind_shop">T-SHIRTS</p></a>
		</div>
        </div>-->
		<div class="col-md-4">
        <div class="ind_prod">
			<a href="product.php?w=4"><img class="img-responsive" src="images/col3.jpg" alt="" style="width:100%;" >
            <p class="ind_shop">SHOES</p></a>
		</div> </div>
        
        <div class="col-md-4">
        <div class="ind_prod">
			<a href="product.php?w=5"><img class="img-responsive" src="images/ties.jpg" alt="" style="width:100%; height:100%" >
            <p class="ind_shop">TIES</p></a>
		</div>
        </div>
		<!--<div class="col-md-3">
        <div class="ind_prod">
			<img class="img-responsive" src="images/col4.jpg" alt="" style="width:100%;" >
            <a href="product.php?w=5&cid=13"><p class="ind_shop">BELTS &amp; WALLETS</p></a>
		</div>
        </div>-->
	</div>
</div>            
...
<div class="container" style="margin-top:15px;">
	<div class="row">
		<div class="col-md-12">
			<a href="clearance.php"><img class="img-responsive" src="images/shoes_banner.jpg" alt="" 
            style="width:100%;" > </a>
		</div>
	</div>
</div>
