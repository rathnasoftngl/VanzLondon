...
<div class="container-fluid navbar-fixed-top" style="background-color:#000000;">
	<div class="container">
    	<div class="row">
...
<input class="SearchButton" value="" title="Search Items" type="submit">-->
			...
			<ul class="header-in">
				...
				<li><a href="#">HELP</a></li>
				<li style="border:1px solid #333333; margin-left:5px; background:#404040; border-radius:10px; padding:1px;"><a href="checkout.php" > CHECK OUT</a></li>
			</ul>
		</div>
...
<div class="container" style="margin-top:15px;">
	<div class="row">
        ...
        <div class="ind_prod">
            ...
            <a href="product.php?w=3"><p class="ind_shop">SUITS</p></a>
		</div>
        </div>
		<div class="col-md-3">
        <div class="ind_prod">
        ...
        <div class="ind_prod">
            ...
            <a href="product.php?w=4"><p class="ind_shop">SHOES</p></a>
		</div>
        </div>
		<div class="col-md-3">
        <div class="ind_prod">
